...
const application_1 = require("./src/api-endpoint/application");
const folder_1 = require("./src/api-endpoint/folder");
const item_1 = require("./src/api-endpoint/item");
const library_1 = require("./src/api-endpoint/library");
class EagleSDK {
    constructor(opts) {
        this.opts = {
